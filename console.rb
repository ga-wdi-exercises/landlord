...
while response != "q"
  puts "Welcome to your landlord interface. Type '1' to see all apartments, '2' to see all tenants, '3' to see a list of apartments with their associate tenants, or 'q' to quit"
  response = gets.chomp
  if response == 1.to_s
