...
# Apartment.destroy_all #destroy all from seed.sql
# Tenant.destroy_all #destroy all from seed.sql
...
belmont = Apartment.create(address: "4500 Belmont Ave", monthly_rent: 1500, sqft: 800, num_beds: 1, num_baths: 1) # apartment_id is 20
oregon = Apartment.create(address: "2300 Oregon St", monthly_rent: 1100, sqft: 600, num_beds: 1, num_baths: 1) # apartment_id is 21
new_york = Apartment.create(address: "9000 New York Ave", monthly_rent: 2500, sqft: 1100, num_beds: 2, num_baths: 2) # apartment_id is 22
