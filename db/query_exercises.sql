...
INSERT INTO tenants(name, age, gender, apartment_id) VALUES ('New_guy', 20, 'Male', 3);
...
SELECT * FROM apartments JOIN tenants ON apartments.id = tenants.apartment_id WHERE monthly_rent >2300;
