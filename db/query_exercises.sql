...
INSERT INTO tenants (name, age, gender, apartment_id) VALUES ('William Pascucci', 20, 'male', 21 );
...
UPDATE tenants SET age = age+1 WHERE age=age;
-- Find all tenants who live in an apartment that costs more than $2300
SELECT * FROM apartments JOIN tenants ON tenants.apartment_id=apartments.id WHERE monthly_rent>2300;
