...
SELECT * FROM tenants WHERE apartment_id IN (20,15);
-- Delete all tenants whose age is greater than 65
DELETE FROM tenants WHERE age > 65;
-- Create one new tenant, put them in any apartment you want
INSERT INTO tenants (name,age,gender,apartment_id) VALUES ('Chase Gruber',24,'male',10);
...
--^ but we just deleted everyone over 65?!?!
...
WHERE apartments.monthly_rent > 2300;
