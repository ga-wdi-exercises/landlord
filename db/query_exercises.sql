...
INSERT INTO tenants (name, age, gender, apartment_id) VALUES ('Joe Shmo', 32, 'Male', 1);
...
UPDATE tenants SET age = 91 WHERE age = 90; -- already deleted all older than 65
-- Change all tenants ages to increase by 1
UPDATE tenants SET age = age + 1;
-- Find all tenants who live in an apartment that costs more than $2300
SELECT * FROM tenants WHERE apartment_id IN (SELECT id FROM apartments WHERE monthly_rent > 2300); 
