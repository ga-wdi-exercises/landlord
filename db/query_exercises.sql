...
INSERT INTO tenants(name, age, gender, apartment_id) VALUES ('Brendan Mahoney', 30, 'Male', 1);
...
SELECT * FROM apartments WHERE rent > 2300;
-- Geriatric Birthday! Update all tenants whose age is 90 to be 91
UPDATE tenants SET age=91 WHERE age=90;
-- Change all tenants ages to increase by 1
UPDATE tenants SET age = age + 1;
-- Find all tenants who live in an apartment that costs more than $2300
SELECT * FROM tenants JOIN apartments ON apartment.id=tenants.apartment_id WHERE rent > 2300;
