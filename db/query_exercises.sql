...
-- Create one new tenant, put them in any apartment you want
  INSERT INTO tenants(name, age, gender, apartment_id) VALUES ('William Clinton', 90, 'Male', 1);
-- Find just the ids for all apartments
  SELECT id FROM aparments;
...
-- Find all tenants who live in an apartment that costs more than $2300
  SELECT * FROM tenants JOIN apartments ON apartments.id=tenants.apartment_id WHERE monthly_rent > 2300;
