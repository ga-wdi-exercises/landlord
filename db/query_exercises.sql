...
INSERT INTO tenants(name, age, gender, apartment_id) VALUES ('Addy Levi', 21, 'Female', 3);
...
SELECT tenants.* FROM tenants JOIN apartments ON apartments.id = tenants.apartment_id WHERE apartments.monthly_rent > 2300;
