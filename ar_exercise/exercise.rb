...
older_tenants = Tenant.where("age > 65", :age)

# get all apartments whose price is greater than $2300
expensive_apartments = Apartment.where("monthly_rent > 2300", :monthly_rent)

# get the apartment with the address "6005 Damien Corners"
damien_apartment = Apartment.where("address = '6005 Damien Corners'", :address)
...
kristin = Tenant.find_by(name: "Kristin Wisoky").increment(:age, 1).save
kristin.age +=1
kristin.save
