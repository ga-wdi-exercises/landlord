...
all_apartments = Apartment.where("age: > ?" "2300")

# get the apartment with the address "6005 Damien Corners"
all_apartments = Apartment.where(address:"6005 Damien Corners")

# get all tenants in that apartment
all_tenants = Tenant.where(apartment_id: 6)
...
apartment = Apartment.where(address:"62897 Verna Walk")
